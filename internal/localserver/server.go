...
import (
	...
	"github.com/minitape/api/go/svc/alert/v1/alertv1connect"
	"github.com/minitape/api/go/svc/dashboard/v1/dashboardv1connect"
	"github.com/minitape/api/go/svc/ingest/v1/ingestv1connect"
	"github.com/minitape/api/go/svc/localhost/v1/localhostv1connect"
	"github.com/minitape/api/go/svc/project/v1/projectv1connect"
	"github.com/minitape/api/go/svc/query/v1/queryv1connect"
