...
```bash
wget -qO- https://github.com/aybabtme/humanlog/releases/download/0.1.12/humanlog_linux.tar.gz | tar xvz
```

## On OS X

```bash
wget -qO- https://github.com/aybabtme/humanlog/releases/download/0.1.12/humanlog_darwin.tar.gz | tar xvz
```
